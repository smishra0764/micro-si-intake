...
export const metadata: Metadata = {
  title: "CRM <-> Contact Center Integration Design Guide (RevOps Blueprint)",
  description:
    "A practical guide to designing CRM and contact center integrations, including customer matching, duplicate prevention, CRM activity creation, agent context, reliability, and security considerations.",
};

const FEEDBACK_URL = "https://forms.gle/FU2wvkb9K8RPVLfU6";

export default function CrmContactCenterIntegrationDesignPage() {
  return (
      ...
      <div className="mx-auto w-full max-w-3xl space-y-10">
        <header className="rounded-2xl border border-neutral-800 bg-neutral-900/40 p-6 space-y-4">
          ...
          <h1 className="text-3xl font-semibold">
            CRM <span aria-hidden>&harr;</span> Contact Center Integration Blueprint
          </h1>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">A Blueprint-First Approach</h2>
          <p className="text-sm text-neutral-300">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">
            Common Problems in CRM <span aria-hidden>&harr;</span> Contact Center Integrations
          </h2>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold">What This Blueprint Defines</h2>
